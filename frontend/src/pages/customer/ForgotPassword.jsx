...
export default function ForgotPassword() {
  ...
  const submit = async (event) => {
    ...
    try {
      const response = await customerAuthApi.forgotPassword({ email })
  ...
  return (
    <AuthLayout
      ...
      subtitle="Enter your customer account email address and we will send you a password reset link."
    >
