...
export default function ActivityLogs() {
  ...
  const hasActiveFilters = Boolean(search || params.module_name || params.action_type)
  ...
  const resetFilters = () => {
    setSearch('')
    updateParams({ search: '', module_name: '', action_type: '', page: 1 })
  }
      ...
      <div className="mb-4">
        <div className="grid gap-3 xl:grid-cols-[1fr_220px_220px_140px]">
          ...
          <select
            ...
            onChange={(event) => updateParams({ ...params, module_name: event.target.value, page: 1 })}
            className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100"
          >
          ...
          <select
            ...
            onChange={(event) => updateParams({ ...params, action_type: event.target.value, page: 1 })}
            className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100"
          >
            ...
            <tbody className="divide-y divide-slate-100">
              {logs.map((log) => (
                <tr key={log.id} className="transition hover:bg-slate-50/80">
                  ...
                  <td className="px-4 py-3 text-center text-slate-600">{date(log.created_at, 'en-US')}</td>
                  <td className="px-4 py-3">
